...
public class MoreItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(MoreItemActivity.this).loadInterstitialAd(this, ADMOB_I[0], FACEBOOK_I[0]);
        AppManage.getInstance(MoreItemActivity.this).showNativeBanner((ViewGroup) adsView0);
        ...
        moreItemToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AppManage.getInstance(MoreItemActivity.this).showCustomAppOpenAd(MoreItemActivity.this, new AppManage.MyCallback() {
                    @Override
